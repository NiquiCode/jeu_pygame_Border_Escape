...
class MainMenu:
    def __init__(self, width, height):
        ...
        # On les place plutôt en bas pour bien voir ton beau logo sur l'image
        ...
        try:
            ...
            self.bg.fill((15, 20, 35)) # Fond de secours
        ...
        while True:
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                    if self.btn_jouer.collidepoint(event.pos): return "JOUER"
                    if self.btn_options.collidepoint(event.pos): return "OPTIONS"
                    if self.btn_quitter.collidepoint(event.pos): return "QUITTER"
    ...
    def dessiner_bouton(self, ecran, rect, texte):
        ...
        pygame.draw.rect(ecran, (0, 255, 255), rect, 2, border_radius=8) # Bordure cyan
